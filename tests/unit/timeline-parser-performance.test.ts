...
describe('时间线解析器性能测试', () => {
  ...
  describe('单次解析性能测试', () => {
    test('PERF-001: 标准内容解析应在100ms内完成', async ({ unitContext }) => {
    ...
    test('PERF-002: 大文本解析性能测试', async ({ unitContext }) => {
    ...
    test('PERF-003: 复杂格式解析性能测试', async ({ unitContext }) => {
  ...
  describe('并发性能测试', () => {
    test('PERF-004: 应该支持100+并发请求', async ({ unitContext }) => {
    ...
    test('PERF-005: 高并发下的错误处理性能', async ({ unitContext }) => {
  ...
  describe('内存使用测试', () => {
    test('PERF-006: 长时间运行不应出现内存泄漏', async ({ unitContext }) => {
    ...
    test('PERF-007: 大对象处理的内存效率', async ({ unitContext }) => {
  ...
  describe('解析器选择性能测试', () => {
    test('PERF-008: 解析器选择策略的效率', async ({ unitContext }) => {
      const testCases = [
    ...
    test('PERF-009: 解析器缓存效果测试', async ({ unitContext }) => {
