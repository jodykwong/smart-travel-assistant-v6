...
describe('数据架构集成测试', () => {
  ...
  describe('主解析器测试', () => {
    test('应该成功解析完整的旅行计划', async ({ unitContext }) => {
      const metadata = {
        id: 'test-plan-123',
        title: '北京5日深度游',
        destination: '北京',
    ...
    test('应该提供详细的解析统计信息', async ({ unitContext }) => {
      const metadata = {
        id: 'test-plan-123',
        title: '北京5日深度游',
        destination: '北京',
  ...
  describe('服务层测试', () => {
    test('应该成功创建旅行计划', async ({ unitContext }) => {
      const metadata = {
        id: 'service-test-123',
        title: '北京5日深度游',
        destination: '北京',
    ...
    test('应该处理解析错误', async ({ unitContext }) => {
  ...
  describe('数据验证测试', () => {
    test('应该验证必需字段', async ({ unitContext }) => {
  ...
  describe('性能测试', () => {
    test('解析性能应该在合理范围内', async ({ unitContext }) => {
      const metadata = {
        id: 'perf-test-123',
        title: '性能测试计划',
        destination: '北京',
  ...
  describe('错误处理测试', () => {
    ...
    test('应该处理格式错误的内容', async ({ unitContext }) => {
